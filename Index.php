...
<body>
	    ...
	    <table id="panierTable">
		    ...
		    ?>
			    <tr>
			        ...
			        <td>
			        	<a style="color: red; text-decoration: none;" href="index.php?action=<?php echo 'supprimer&lp='.$_SESSION['panier']['libelleProduit'][$key] ?>">Supprimer</a>
			        </td>
			    </tr>
			<?php
		    }
	...
	<p <?php if (!array_key_exists("panier", $_SESSION)) {echo "style='display:none'";} ?> id="btn_sup"><a href="index.php?action=vider">Vider le panier</a></p>
	...
	<div id="BoxProd">
		<?php
			...
			while($Resultat = $Requete->fetch(PDO::FETCH_ASSOC)){
				...
				<div id="Produit">
					<div>
						<img src="<?php echo 'Vendeur/'.$source ?>" >
		...
		<p>
			...
			<?php
				...
				if ($NbrePage > 1) {
					...
					if ($page > 1) { ?>
						<li>
							<a href="Index.php?page=<?php echo ($page - 1) ?>" class="fas fa-arrow-left" title='LienPage'>
							</a>
						</li>

						<li>
							<a href="Index.php?page=<?php echo ($page + 1) ?>" <?php if($NbrePage == $page){ echo "style='display:none;'";} ?> class="fas fa-arrow-right" title='LienPage'>
							</a>
						</li>
			...
			<?php	
					//Vérification : si la variable Page contient une valeur inférieure à 1
						...
						<li>
							<a href="Index.php?page=<?php echo ($page + 1) ?>" class="fas fa-arrow-right" title='LienPage'>
							</a>
						</li>
			<?php	}
				} ?>
